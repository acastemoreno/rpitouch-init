defmodule Rpitouch.Component.Nav do
...
#  import Scenic.Clock.Components
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", Rpitouch.Scene.Sensor},
           {"Primitives", Rpitouch.Scene.Primitives},
           {"Components", Rpitouch.Scene.Components},
           {"Transforms", Rpitouch.Scene.Transforms}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
